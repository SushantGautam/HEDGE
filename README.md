...
- `experiments/` – paper experiment scripts (2026 re-runs, table generation, combine utilities); run them from inside `experiments/`. `experiments/archive/` holds superseded versions.
- `results/` – cached experiment outputs (parquet/pickle; gitignored):
  - `results/redo_2026/` – active 2026 re-run results and clustering caches
  - `results/2025_oct/` – Oct-2025 generation + NLI caches
  - `results/archive/` – stale runs superseded by the 2026 re-runs
