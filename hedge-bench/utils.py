from hedge-bench.algorithms import sentence_semantic_entropy, radflag, vase
import hashlib
import torch
...
import optuna
import asyncio
from hedge-bench.algorithms import cluster_terms_by_embedding, cluster_terms_by_nli, get_nli_labels, cluster_from_nli_labels
...
def generate_answers_swift(vqa_rad_test, n_answers_high=20, min_temp=0.1, max_temp=1.0, prompt_variants=None):
    from hedge-bench.tests.medgemma import infer_batched as infer_fn
